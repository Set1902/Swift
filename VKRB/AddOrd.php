...
// insert
$sql = "UPDATE Menu.Order SET Order_id = $Order_id, Date_and_time = '$Date_and_time', Sotr_id = $Sotr_id, Cust_id = $Cust_id, Pizzeria_id = $Pizzeria_id, Price = '$Price', Oplata = $Oplata WHERE Order_id = $Order_id";
    //"INSERT INTO Menu.Order (Order_id, Date_and_time, Sotr_id, Cust_id, Pizzeria_id, Price, Oplata)
